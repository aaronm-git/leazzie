...
export function LeaseCalculator() {
  ...
  const calculateLease = (inputs: LeaseInputs): LeaseCalculation => {
    ...
    const depreciationFee = (netCapitalizedCost - residualValue) / inputs.leaseTerm
    const monthlyInterestRate = inputs.interestRate / 100 / 12
    const financeFee = (netCapitalizedCost + residualValue) * monthlyInterestRate
  ...
  const handleInputChange = (field: keyof LeaseInputs, value: string) => {
    ...
    if (field === "vehiclePrice" || field === "dealerIncentives") {
      ...
      if (field === "vehiclePrice") {
        newInputs.sellingPrice = calculateSellingPrice(numericValue, inputs.dealerIncentives)
        // Also update estimated residual value when MSRP changes
        newInputs.residualValue = calculateEstimatedResidual(numericValue, inputs.leaseTerm)
      } else {
        newInputs.sellingPrice = calculateSellingPrice(inputs.vehiclePrice, numericValue)
      }
      setInputs(newInputs)
    } else if (field === "leaseTerm") {
      // Auto-calculate residual when lease term changes
      const newInputs = { ...inputs, [field]: numericValue }
      newInputs.residualValue = calculateEstimatedResidual(inputs.vehiclePrice, numericValue)
      setInputs(newInputs)
    } else {
      setInputs((prev) => ({
        ...prev,
  ...
  return (
    <div className="mx-auto max-w-6xl p-8">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="mb-2 text-3xl font-bold text-gray-900">Vehicle Lease Calculator</h2>
        <p className="text-gray-600">Calculate your estimated monthly lease payment with detailed breakdown</p>
      </div>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your vehicle and financing information to calculate your monthly lease payment
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="vehiclePrice" className="flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange("dealerIncentives", e.target.value)}
                      placeholder="2000"
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="sellingPrice" className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-green-600 font-medium">
                        ({calculatePercentageOff(inputs.vehiclePrice, inputs.sellingPrice).toFixed(1)}% off MSRP)
                      </span>
                    </Label>
                    <Input
                      id="sellingPrice"
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900">Trade-in Information</h3>
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange("tradeInPayoff", e.target.value)}
                      placeholder="0"
                    />
                  </div>
                </div>
              ...
              {/* Financing Terms */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900">Financing Terms</h3>
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="leaseTerm" className="flex items-center gap-2">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="residualValue" className="flex items-center gap-2">
                      <DollarSign className="h-4 w-4" />
                      Residual Value
                      <span className="text-sm text-blue-600 font-medium">
                        ({((inputs.residualValue / inputs.vehiclePrice) * 100).toFixed(1)}% of MSRP)
                      </span>
                    </Label>
                    <Input
                      id="residualValue"
        ...
        <div className="space-y-6">
          ...
          <Card className="border-2 border-blue-200 bg-blue-50">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl text-blue-900">Monthly Payment</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <div className="text-4xl font-bold text-blue-900">{formatCurrency(calculation.monthlyPayment)}</div>
              <p className="mt-2 text-sm text-blue-700">Estimated monthly lease payment</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{formatCurrencyDetailed(calculation.depreciationFee)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Finance Fee:</span>
                <span className="font-medium">{formatCurrencyDetailed(calculation.financeFee)}</span>
              </div>
              <Separator />
              <div className="flex justify-between font-semibold">
                <span>Total Monthly:</span>
                <span>{formatCurrencyDetailed(calculation.monthlyPayment)}</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Dealer Incentives:</span>
              ...
              <div className="flex justify-between font-medium text-green-700">
                ...
                <span>
                  ...
                  {calculatePercentageOff(inputs.vehiclePrice, inputs.sellingPrice).toFixed(1)}% off)
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Calculated Taxes ({inputs.taxRate}%):</span>
                <span>
                  +
                  {formatCurrency(
                    calculateTaxes(
          ...
          <Card className="border-amber-200 bg-amber-50">
            <CardContent className="pt-6">
              <p className="text-xs text-amber-800">
                <strong>Disclaimer:</strong> This calculator provides estimates only. Actual lease terms may vary based
                on credit approval, dealer incentives, and other factors. Consult with your dealer for accurate pricing.
              </p>
            </CardContent>
          </Card>
        </div>
